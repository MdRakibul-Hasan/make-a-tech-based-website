...
const ProductDetails = () => {
    ...
    return (
        <div>
            ...
            <div className="flex justify-center items-center w-full pb-28 px-10 mt-20 max-md:flex-col max-md:px-3">
...
<div className="w-1/2 max-md:w-full flex flex-col gap-1">
    <h2 className=" text-2xl font-semibold">{name}</h2>
                    ...
                    <button onClick={handleClickOnAddToCart} className=" bg-red-500 text-white px-3 py-1 rounded-lg w-[30%] mt-4">Add to Cart</button>
